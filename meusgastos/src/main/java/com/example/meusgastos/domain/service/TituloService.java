...
public class TituloService implements 
    ICRUDService<TituloRequestDTO,TituloResponseDTO> {
    @Autowired
    ...
    private void validarTitulo (TituloRequestDTO dto){
        ...
        dto.getValor() == null || dto.getDescricao() == null){
            throw new ResourceNotFoundException("Titulo Inválido - Campos Obrigatórios! ");
        }
    }
    public List<TituloResponseDTO> obterPorDataVencimento(String periodoInicial
    ,String periodoFinal){
